...
function control(){setCookie(testVar);sendGA(testVar);sendDL(testVar);debugging(testVar);}
function variation(){optimization();setCookie(testVar);sendGA(testVar);sendDL(testVar);debugging(testVar);}
...
function debugging(message){if(debug==1){console.log(message);}}
